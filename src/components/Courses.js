...
export default function Courses() {
  ...
  return (
    <>
      ...
      <hr />
      <section id='offers' style={{ height: '125vh' }}>
              ...
              <div className='list'>
                ...
                <div>
                  ...
                  <p>
                    ...
                    Benefit from our experienced instructor  s and industry professionals who bring a wealth of knowledge and practical insights to the classroom. Learn from the best to become the best.
                  </p>
                </div>
              </div>
              <div className='list'>
                ...
                <div>
                  <span>  Job-Relevant Curriculum:  </span>
                  <p>

                    Our courses are designed in collaboration with industry experts, ensuring that you acquire the most up-to-date and in-demand skills that employers are seeking.
                  </p>
                </div>
              </div>
              <div className='list'>
      ...
      {/* learning */}
      <section id='learning' >
        <div class="learning-container" style={{ height: '80vh' }}>
